    ...
    <div>
      <div className="max-w-md p-8 sm:flex sm:space-x-6 dark:bg-gray-900 dark:text-gray-100">
        <div className="flex-shrink-0 w-full mb-6 h-44 sm:h-32 sm:w-32 sm:mb-0">
          <img
            src={cuser.uid? cuser.photoURL : 'https://i.pinimg.com/originals/09/24/a7/0924a7ef295741e916c8f42512bbe5bd.jpg'}
            alt=""
        ...
        <div className="flex flex-col space-y-4">
          <div>
            <h2 className="text-2xl font-semibold"> { cuser && cuser.displayName}</h2>
